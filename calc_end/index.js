...
let incomeItem = document.querySelectorAll('.incmoe-items');
...
let appData = {
  ...
  getIncome: function () {
    if (confirm('Есть ли у вас дополнительный заработок?')) { // Временная заглушка
    ...
    for (let key in appData.income) { // Должно остаться
